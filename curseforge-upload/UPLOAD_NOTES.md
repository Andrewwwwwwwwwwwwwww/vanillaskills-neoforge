# VanillaSkills — NeoForge, MC 26.2 — CurseForge Upload (2.1.10)
...
## Mod jar
**File:** `vanillaskills-2.1.10+mc26.2-neoforge.jar`
- Minecraft **26.2**, loader tag **NeoForge** (NOT "Forge")
- Requires NeoForge **26.2.0.7-beta or newer**; no Fabric API dependency
- Release type: Release
- Feature-equal with the Fabric 2.1.10 file; parity is enforced by `tools/check-parity.js`.
